  ...
  return (
    <div>
      ...
      <div className="py-7">
        ...
        <p className="text-justify text-wrap w-[60%] text-lg" style={{ margin: "30px auto", wordSpacing: 5, lineHeight: 2 }}>44SATURN is more than just a name—it’s a statement.
        </p>
        <p className="text-justify text-wrap w-[60%] text-lg" style={{ margin: "30px auto", wordSpacing: 5, lineHeight: 2 }}>
